...
manifest = {
    "phase": "Phase 18 Full Autonomous Closed-Loop Engineering Cycle",
    "starting_commit": "4afbc7e",
    "branch": "main",
    ...
    "test_suite_status": "230 repository unit & integration tests passing 100%"
}

with open(os.path.join(results_dir, "phase18_starting_manifest.json"), "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2)

md_lines = [
    "# Phase 18 Starting State Manifest",
    "",
    "## 1. Environment & Baseline Configuration",
    "",
    f"- **Starting Commit**: `{manifest['starting_commit']}`",
    f"- **Branch**: `{manifest['branch']}`",
    f"- **Clean Working Tree**: {manifest['clean_working_tree']}",
...
with open(os.path.join(results_dir, "phase18_starting_manifest.md"), "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Saved phase18_starting_manifest.json and phase18_starting_manifest.md successfully.")
