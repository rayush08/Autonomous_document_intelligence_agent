...
manifest = {
    "phase": "Phase 16 Full Autonomous Closed-Loop Engineering Cycle",
    "starting_commit": "f2fb893",
    "branch": "main",
    ...
    "test_suite_status": "210 repository unit & integration tests passing 100%"
}

with open(os.path.join(results_dir, "phase16_starting_manifest.json"), "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2)

md_lines = [
    "# Phase 16 Starting State Manifest",
    "",
...
with open(os.path.join(results_dir, "phase16_starting_manifest.md"), "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Saved phase16_starting_manifest.json and phase16_starting_manifest.md successfully.")
