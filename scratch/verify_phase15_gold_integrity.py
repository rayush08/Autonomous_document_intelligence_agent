...
with open(os.path.join(results_dir, "phase15_gold_integrity.json"), "w", encoding="utf-8") as f:
...
with open(os.path.join(results_dir, "phase15_gold_integrity.md"), "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Saved phase15_gold_integrity.json and phase15_gold_integrity.md successfully.")
