...
manifest = {
    "phase": "Phase 15 Full Autonomous Closed-Loop Engineering Cycle",
    "starting_commit": "43d33f1",
    "branch": "main",
    ...
    "test_suite_status": "182 repository unit & integration tests passing 100%"
}

with open(os.path.join(results_dir, "phase15_starting_manifest.json"), "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2)

md_lines = [
    "# Phase 15 Starting State Manifest",
    "",
...
with open(os.path.join(results_dir, "phase15_starting_manifest.md"), "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Saved phase15_starting_manifest.json and phase15_starting_manifest.md successfully.")
