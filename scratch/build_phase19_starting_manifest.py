...
manifest = {
    "phase": "Phase 19 Full Autonomous Closed-Loop Engineering Cycle",
    "starting_commit": "f382b33",
    "branch": "main",
    ...
    "test_suite_status": "240 repository unit & integration tests passing 100%"
}

with open(os.path.join(results_dir, "phase19_starting_manifest.json"), "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2)

md_lines = [
    "# Phase 19 Starting State Manifest",
    "",
...
with open(os.path.join(results_dir, "phase19_starting_manifest.md"), "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Saved phase19_starting_manifest.json and phase19_starting_manifest.md successfully.")
