...
with open(os.path.join(results_dir, "phase19_gold_integrity.json"), "w", encoding="utf-8") as f:
...
with open(os.path.join(results_dir, "phase19_gold_integrity.md"), "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Saved phase19_gold_integrity.json and phase19_gold_integrity.md successfully.")
