...
with open(os.path.join(results_dir, "phase14_gold_integrity.json"), "w", encoding="utf-8") as f:
    json.dump(integrity, f, indent=2)

md_lines = [
    "# Phase 14 Gold Data Integrity Report",
    "",
...
with open(os.path.join(results_dir, "phase14_gold_integrity.md"), "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Saved phase14_gold_integrity.json and phase14_gold_integrity.md successfully.")
